                    ...
                    <?php while ( have_posts() ) : the_post(); ?>
						...
						<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
							...
							<section class="gb-post-content">                        
								...
								<p style="float:left;">
									<?php $mspict = wp_get_attachment_image_src( get_post_meta($post->ID,'GB_ms-pict',true),'large'); 
									if (!empty($mspict)) echo'<img class="alignleft" src="'.$mspict[0].'" />'; ?>
                                ...
                                <div class="gb-mobile-suit-genealogy">
                                	<?php
										...
										if (($temp != 0) || ($temp != '')){
											$featimg = wp_get_attachment_image_src( get_post_meta($temp,'GB_ms-pict',true),'large'); 
										...
										<?php if (($ms_new == true) || (!empty($ms_old))):
											...
											if (!empty($ms_new)) {
												...
												while ($wp_query->have_posts()) : $wp_query->the_post(); 
													$featimg = wp_get_attachment_image_src( get_post_meta($post->ID,'GB_ms-pict',true),'large'); ?>
												<li>
