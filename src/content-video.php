...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <header class="row template-content-video">
        ...
        <section id="gb-post-meta-b" class="col-xs-12 col-sm-5 col-md-5 col-lg-12">
            <p class="gb-post-meta-post" style="float:left;text-align:left;">Posted By: Admin | Posted on 10/10/10</p>
        </section>
    ...
    <section class="gb-post-content template-content-video">                        
