...
function optionsframework_options() {
	...
	$options[] = array( "name" => "Blog page",
						"desc" => "Select the page set for blog",
						"id" => "w2f_blog_page",
						"type" => "select",
						"options" => $options_pages);		

	$options[] = array( "name" => "Album page",
						"desc" => "Select the page set for album",
						"id" => "w2f_album_page",
						"type" => "select",
						"options" => $options_pages);	
	...
	$options[] = array( "name" => "Wedding ",
						"type" => "heading");	

	$options[] = array( "name" => "Wedding date",
						"desc" => "Enter in the following format MM/DD/YYYY .",
						"id" => "w2f_wed_date",
						"std" => "",
						"type" => "text");	
							
	$options[] = array( "name" => "Wedding location",
						"desc" => "Wedding location name.",
						"id" => "w2f_wed_location",
						"std" => "",
						"type" => "text");		
	...
	$options[] = array( "name" => "Header image",
						"desc" => "Upload an for the site header.",
						"id" => "w2f_header",
						"type" => "upload");											

	$options[] = array( "name" => "Bride ",
						"type" => "heading");	

	$options[] = array( "name" => "Bride first name",
						"desc" => "Bride first name",
						"id" => "w2f_bfname",
						"std" => "",
						"type" => "text");	
						
	$options[] = array( "name" => "Bride last name",
						"desc" => "Bride last name",
						"id" => "w2f_blname",
						"std" => "",
						"type" => "text");							

	$options[] = array( "name" => "Bride location",
						"desc" => "Place bride from",
						"id" => "w2f_blocation",
						"std" => "",
						"type" => "text");
						
									
	$options[] = array( "name" => "Bride photo",
						"desc" => "Upload a photo of bride.",
						"id" => "w2f_bridepic",
						"type" => "upload");							
						
	$options[] = array( "name" => "Bride closeup photo",
						"desc" => "Upload a closeup photo of bride.",
						"id" => "w2f_brideclose",
						"type" => "upload");						

	$options[] = array( "name" => "Bride story",
						"desc" => "",
						"id" => "w2f_bstory",
						"std" => "",
						"type" => "textarea");	
	...
	$options[] = array( "name" => "Groom ",
						"type" => "heading");	

	$options[] = array( "name" => "Groom first name",
						"desc" => "Groom first name",
						"id" => "w2f_gfname",
						"std" => "",
						"type" => "text");	
						
	$options[] = array( "name" => "Groom last name",
						"desc" => "Groom last name",
						"id" => "w2f_glname",
						"std" => "",
						"type" => "text");							

	$options[] = array( "name" => "Groom location",
						"desc" => "Place groom from",
						"id" => "w2f_glocation",
						"std" => "",
						"type" => "text");
						
									
	$options[] = array( "name" => "Groom photo",
						"desc" => "Upload a photo of groom.",
						"id" => "w2f_groompic",
						"type" => "upload");							
						
	$options[] = array( "name" => "Groom closeup photo",
						"desc" => "Upload a closeup photo of groom.",
						"id" => "w2f_groomclose",
						"type" => "upload");						

	$options[] = array( "name" => "Groom story",
						"desc" => "",
						"id" => "w2f_gstory",
						"std" => "",
						"type" => "textarea");	
