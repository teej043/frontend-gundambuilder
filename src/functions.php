...
function gndmbldr_scripts() {
  ...
  wp_enqueue_script( 'bootstrapjs', get_template_directory_uri() . '/js/assets/bootstrap.js', array( 'jquery' ), '20120206', false);
	...
	// sidebar sticky
	wp_enqueue_script( 'resize-sensor', get_template_directory_uri() . '/js/assets/ResizeSensor.min.js', array('jquery'), '20120206', true );
	wp_enqueue_script( 'sticky-sidebar', get_template_directory_uri() . '/js/assets/theia-sticky-sidebar.min.js', array('jquery'), '20120206', true );
	...
	wp_enqueue_script( 'videoplayer', get_template_directory_uri() . '/js/assets/videoplayer.js', array(), '20120206', true );
...
function add_google_recaptcha($submit_field) {
	$submit_field['submit_field'] = '<div class="g-recaptcha" data-sitekey="6LeB-HMUAAAAAHBRWmBFywGJ5bQNadBhEtc13D9K"></div><br>' . $submit_field['submit_field'];
	return $submit_field;
}
...
$captcha_postdata = http_build_query(array(
													'secret' => '6LeB-HMUAAAAAFcwG_O2wFYmVVfdgN4ltFwz-phS',
													'response' => $captcha,
